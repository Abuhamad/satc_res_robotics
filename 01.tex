...
Despite this incredible progress, investigating the security and trustworthiness of generalist robots remains challenging and almost unexplored. 
This proposal presents three conceptual and practical ideas to address this gap: 
...
\begin{tikzpicture}[
  timeline/.style={ultra thick, draw=black!60, rounded corners=3pt},
    ...
    \draw[timeline,line width=6pt] (0.5,-1) to[out=-180, in=180] (0.5,-3);
    \draw[-, line width=0.5pt, draw=white] (0.5,-1) to[out=-180, in=180] (0.5,-3);
    \draw[timeline,line width=6pt] (0.5,-3) -- (15,-3);
    \draw[-, line width=0.5pt, draw=white] (0.5,-3) -- (15,-3);
    \draw[timeline,line width=6pt] (15,-3) to[out=-0, in=0] (15,-4);
    \draw[-, line width=0.5pt, draw=white] (15,-3) to[out=-0, in=0] (15,-4);
    \draw[timeline,line width=6pt] (15,-4) -- (1,-4); 
    \draw[-, line width=0.5pt, draw=white] (15,-4) -- (1,-4);
    \draw[-stealth, line width=6pt, draw=black!60] (1,-4) -- (0.8,-4);
    ...
    \node[event2024] (deer) at (0.9,-1) {\cite{yue2024deer}};
    \node[label, below=3pt of deer] {Deer-VLA };
    
    \node[event2024] (uni) at (2.7,-1) {\cite{zhang2024uni}};
    \node[label, below=3pt of uni] {Uni-NaVid };
    
    \node[event2024] (revla) at (4.3,-1) {\cite{dey2024revla}};
    \node[label, below=3pt of revla] {ReVLA };

    \node[event2024] (occllama) at (5.8,-1) {\cite{wei2024occllama}};
    \node[label, below=3pt of occllama] {Occllama };

    \node[event2024] (pi0) at (7.2,-1) {\cite{black2024pi_0}};
    \node[label, below=3pt of pi0] {Pi-01 };

    \node[event2024] (rdt) at (8.5,-1) {\cite{liu2024rdt}};
    \node[label, below=3pt of rdt] {RDT-1B };

    \node[event2024] (cogact) at (10,-1) {\cite{li2024cogact}};
    \node[label, below=3pt of cogact] {CogAct };

    \node[event2024] (edgevla) at (11.8,-1) {\cite{budzianowski20edgevla}};
    \node[label, below=3pt of edgevla] {EdgeVLA };

    \node[event2024] (showui) at (13.4,-1) {\cite{lin2024showui}};
    \node[label, below=3pt of showui] {ShowUI };

    %%% Robotics Focus %%%
    \node[event2024] (navila) at (1, -3) {\cite{cheng2024navila}};
    \node[label, above=3pt of navila] {NaviLa};

    \node[event2024] (quar) at (2.5, -3) {\cite{ding2024quar}};
    \node[label, above=3pt of quar] {Quar-VLA};

    \node[event2024] (bivla) at (4.4, -3) {\cite{gbagbe2024bi}};
    \node[label, above=3pt of bivla] {Bi-VLA};

    \node[event2024] (robomamba) at (6.3, -3) {\cite{liu2024robomamba}};
    \node[label, above=3pt of robomamba] {RoboMamba};

    \node[event2025] (otter) at (7.8, -3) {\cite{huang2025otter}};
    \node[label, above=3pt of otter] {Otter};

    \node[event2025] (pointvla) at (9.2, -3) {\cite{li2025pointvla}};
    \node[label, above=3pt of pointvla] {PointVLA};

    \node[event2025] (combatvla) at (11.3, -3) {\cite{chen2025combatvla}};
    \node[label, above=3pt of combatvla] {CombatVLA};

    \node[event2025] (hybridvla) at (13.5, -3) {\cite{liu2025hybridvla}};
    \node[label, above=3pt of hybridvla] {HybridVLA};
...
In this project, over its five-year duration, the PI will work to establish foundational research and collaborative efforts to develop comprehensive frameworks and benchmarks that build toward secure and reliable robotic models. 
