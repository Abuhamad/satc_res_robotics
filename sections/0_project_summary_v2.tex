...
\BfPara{Keywords} trustworthy AI/ML security; robotic foundation models; vision-language-action models; adversarial robustness; multimodal security; safety benchmarking. % VERIFY first keyword against NSF 25-515 controlled list
