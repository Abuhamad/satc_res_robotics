...
argument-hint: 'Follow these guidelines to create effective, portable Agent Skills that enhance GitHub Copilot with specialized capabilities, workflows, and bundled resources. Triggered by user requests, file types, or prompt relevance.'
