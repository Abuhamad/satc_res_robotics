...
\subsection{T1:  Robotic Models under High Adversarial Capability: White-box Attacks} \label{sec:t1_1}
...
\subsection{T2: Robotic Models under Restricted Adversarial Capability: Gray and Black-box Attacks} \label{sec:t1_2}
...
\subsection{T3: Defending Robotic Models against Adversarial Attacks} \label{sec:t1_4}
