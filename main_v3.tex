...
\subsubsection{T2-1: Gray-box Attacks}\label{t2_1}
...
\BfPara{Proposed Attack} While we continue to investigate language-based attacks (\eg SHIELD \autoref{fig:lang_black_box}), we propose vision-based attack, TTDA.
...
We additionally report the query-efficiency curve (episodes reaching $\rho$ versus queries used) and the privacy metrics of \autoref{sec:t2}.


%todo: add limited-access with multimodal attacks discussion
