...
As end-to-end techniques and integration of LLM and VLM backbones become more prevalent~\cite{9} (see the evolution of robotic models in \autoref{fig:vla-timeline}), security research for these models is limited. Generalist robotic models continue to emerge rapidly through 2025 and 2026~\cite{gr00tn1,geminirobotics2025,pi05_2025,rdt1b,openvla_oft}, extending the trend shown in \autoref{fig:vla-timeline} beyond its early-2025 horizon. Ensuring that these models are resilient to adversarial attacks is crucial and requires immediate attention.
